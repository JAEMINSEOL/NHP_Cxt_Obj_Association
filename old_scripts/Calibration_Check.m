...
[X_lp,Y_lp,X_lp_deg, Y_lp_deg,Eye_sacc_XY_index_lp] = Eye_Classification_lowpassfilter(Eye_Analog_datapixx);
%%
...
scatter(FixPoint(end-2:end-1,1), FixPoint(end-2:end-1,2),10,c(Cali_index(i,2),:),'filled')
hold on
...
line(FixPoint(end-2:end-1,1), FixPoint(end-2:end-1,2),'Color','k')
line(FixPoint(end-1:end,1), FixPoint(end-1:end,2),'Color','k')
       end
   end
